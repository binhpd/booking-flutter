              ...
              child: Column(
                children: [
                  ...
                  Row(
                    ...
                    children: [
                    SizedBox(width: 100, child: Text(ticket['from']['name'], style: Styles.headLineStyle4.copyWith(color: Colors.white )),),
                ...
                children: [
                  ...
                  Column(
                    children: [
                      ...
                      const Gap(5),
                      Text(ticket['number'].toString(), style: Styles.headLineStyle4.copyWith(color: Colors.white),)
                    ],
                  )
                ],
              ),
